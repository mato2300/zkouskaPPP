  ...
  return (
    <div name="home" className="w-full h-screen bg-blue-600">
        ...
        <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
            ...
            <p className="text-white py-4 max-w-[900px] text-2xl font-bold"><span className='text-4xl'>P</span>rofesní kvalifikace Poradce/poradkyně pro pozůstalé je potvrzením, že daný pracovník disponuje
