            ...
            <div className="max-w-[1000px] w-full grid grid-cols-2 gap-8">
                ...
                <div className="max-w-[1300px] w-full grid sm:grid-cols-2 gap-8 px-4">
                    <div className="sm:tetxt-right text-white">
                        ...
                        {/* <p>
                            Vystudovala jednooborovou psychologii na Filozofické fakultě Univerzity Palackého v Olomouci a
...
<div className="space-y-4">
  <p>
    Vystudovala jednooborovou psychologii na Filozofické fakultě Univerzity Palackého v Olomouci
   a tamtéž sociologii a andragogiku v profilaci na sociální práci.
  </p>
  ...
  <p>
    V současné době se však zaměřuje primárně na klinickou praxi, působí jako psycholog ve zdravotnictví v Odborném léčebném ústavu Paseka a v Psychiatrické nemocnici ve Šternberku. 
    Profesně se specializuje především na problematiku zvládání náročných životních situací, gerontologii, thanatologii a péči o pozůstalé.
  </p>
  ...
  <p>
    Spolupracuje s různými institucemi, například s Asociací poradců pro pozůstalé, Dlouhou cestou apod. 
    Je průkopníkem poradenství pro pozůstalé v ČR a první autorizovanou osobou v této oblasti.
  </p>
</div>
                    </div>
